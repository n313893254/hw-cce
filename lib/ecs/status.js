...
ECS.prototype.batchActionCloudServer = function (serverIds, action, force, callback) {
  if (!serverIds) {
    throw new Error('Argument `serverIds` must be present')
  }
 ...
 * @method startCloudServers
 * @param {Array}     serverId server id
 * @param {Function}  callback  Function to be called when request done
 * @return
 */
ECS.prototype.startCloudServers = function (serverId, callback) {
 ...
 * @method stopCloudServers
 * @param {Array}     serverId server id
 * @param {Boolean}   force     force to stop
 * @param {Function}  callback  Function to be called when request done
 * @return
 */
ECS.prototype.stopCloudServers = function (serverId, force, callback) {
  this.submitActionToCloudServer(serverId, 'stop', force, callback)
}
 ...
 * @method rebootCloudServers
 * @param {Array}     serverId server id
 * @param {Boolean}   force     force to stop
 * @param {Function}  callback  Function to be called when request done
 * @return
 */
ECS.prototype.rebootCloudServers = function (serverId, force, callback) {
 ...
 * @method resizeCloudServers
 * @param {String}    serverId server id
 * @param {String}    flavorId flavor id
 * @param {Function}  callback Function to be called when request done
 * @return
 */
ECS.prototype.resizeCloudServers = function (serverId, flavorId, callback) {
  if (!serverId && !flavorId) {
