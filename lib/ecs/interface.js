...
ECS.prototype.attachCloudServerInterface = function (serverId, portId, netId, fixedIp, callback) {
  ...
  var formdata = {
    'interfaceAttachment': {
      'port_id': 'ee29ecf1-9dd0-4a9e-9db9-4718b3e5b0d3'
      // 'net_id': netId,
      // 'fixed_ips': [{
      //   'ip_address': fixedIp
      // }]
 ...
 * @return
 */
ECS.prototype.detachBatchCloudServerInterface = function (serverId, portId, callback) {
  var resource = '/v1/' + this.projectId + '/cloudservers/' + serverId + '/nics/delete'
  var formdata = {
    'nics': [
      {
        'id': 'cadc4dff-54c8-4e65-9bca-0aa5e521d9a1'
      },
      {
        'id': 'ee29ecf1-9dd0-4a9e-9db9-4718b3e5b0d3'
      }
    ]
  }
  this.requestor.post(resource, formdata, callback)
