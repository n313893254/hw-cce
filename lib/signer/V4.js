...
class V4 {
  ...
  sign (request) {
    ...
    request.set('Cookie', 'R_USERNAME=admin; CSRF=07980d91df; R_SESS=token-qlcp7:gvl6cp6q45l78tjznsbfx9z9zgjtp47dzxmt896cpzl6dvhlg7229d')  // add authorization header
  }
