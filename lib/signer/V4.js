...
class V4 {
  ...
  sign (request) {
    ...
    request.set(Constants.CONTENT_TYPE, 'rancher:application/json')   // add x-sdk-date header
    // request.set(Constants.HOST, 'vpc.cn-north-1.myhuaweicloud.com')   // add x-sdk-date header
    ...
    request.set('Host', 'vpc.cn-north-1.myhuaweicloud.com:443')  // add authorization header
    request.set('Cookie', 'CSRF=d521912b9e; R_SESS=token-jntkn:9ktr7jhdhbc7p848jp2w92kg6jx99mmgd7nf4q4mdkbp4zdzvnlfvk')  // add authorization header
  }
